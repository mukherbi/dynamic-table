...
var TableComponent = /** @class */ (function () {
    function TableComponent(httpClient) {
    ...
    TableComponent.prototype.getData = function () {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('getAllData', this.getAllData.toString());
        this.httpClient.get('http://localhost:8080/data', { params: params }).subscribe(function (data) {
...
module.exports = __webpack_require__(/*! C:\Angular\dynamic-table\src\angular\table-app\src\main.ts */"./src/main.ts");
